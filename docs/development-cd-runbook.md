...
> 2026-09-15 최신 실제 상태는 [현재 운영 구성](mac-mini-runtime.md)을 우선한다. a26264e 이미지 전환·결과 11건 이관·controller 초기화는 완료했으며, 상시 자동 배포도 사용자 후속 승인으로 60초 주기 활성화했다. 아래 과거 미배포/472aff7 기록과 구분한다. 프론트·Vercel은 변경하지 않았다.
